...
namespace CSharp_Basics
{
    ...
    public class DataTypesAndVariables
    {
        ...
        public void Operation_On_Integers()
        {
            ...
            Assert.That(divide, Is.TypeOf<double>(), "You sure it is int - no : double?");
        }
        ...
        public void float_double_decimal()
        {
            ...
            Assert.GreaterOrEqual(140000000000000000000000000.001, add, "Example Has wrong value did you changed it?");
            Assert.GreaterOrEqual(140000000000000000000000000.0, subtract, "Wrong value maybe other way around?");
            Assert.That(subtract, Is.TypeOf<double>(), "You sure it is int?");
            Assert.AreEqual(0.112, multiply, "Example Has wrong value did you changed it?");
            Assert.That(multiply, Is.TypeOf<double>(), "You sure it is int?");
            Assert.LessOrEqual(140000000000000000000000000.0, divide, "Example Has wrong value did you changed it?");
            Assert.That(divide, Is.TypeOf<double>(), "You sure it is int - no : double?");
